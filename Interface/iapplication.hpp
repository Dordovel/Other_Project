    ...
    namespace APPLICATION
    {
        class IApplication
        {
            public:
                ...
                virtual PROJECT::BASE::DATA::Vector2F map_pixel_to_coords(PROJECT::BASE::DATA::Vector2I position) = 0;
                ...
                virtual void set_view(std::shared_ptr<PROJECT::APPLICATION::IView> view) = 0;
