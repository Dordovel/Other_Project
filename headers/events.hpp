...
{
    class Events final : public PROJECT::EVENT::IEvents
    {
        private:
        ...
        public:
            ...
            void key_released_event(int key , const std::function<void()>& fun) noexcept override;

            void catch_events_loop() override;
            
            void catch_events_none() override;
