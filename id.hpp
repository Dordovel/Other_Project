...
const static std::string NPC_JEREMY_GREEN = "NPC_JEREMY_GREEN";
const static std::string NPC_JEREMY_PINK = "NPC_JEREMY_PINK";
const static std::string NPC_MARTHA_BLONDE = "NPC_MARTHA_BLONDE";
const static std::string NPC_MARTHA_GREEN = "NPC_MARTHA_GREEN";
const static std::string NPC_MARTHA_PINK = "NPC_MARTHA_PINK";
